...
describe("event presentation", () => {
  ...
  it("advances upcoming and live from the clock without mutating stored phase", () => {
    expect(
      phaseAfterClock("upcoming", "2026-08-16T18:00:00.000Z", "2026-08-17T18:00:00.000Z", "2026-08-16T12:00:00.000Z"),
    ).toEqual({ phase: "upcoming", remaining: 6 * 3600 * 1000 });
    expect(
      phaseAfterClock("upcoming", "2026-08-16T18:00:00.000Z", "2026-08-17T18:00:00.000Z", "2026-08-16T18:00:00.000Z"),
    ).toMatchObject({ phase: "live" });
    expect(
      phaseAfterClock("live", "2026-08-16T18:00:00.000Z", "2026-08-17T18:00:00.000Z", "2026-08-17T18:00:00.000Z"),
    ).toEqual({ phase: "finalizing", remaining: 0 });
    expect(
      phaseAfterClock("archived", "2026-08-16T18:00:00.000Z", "2026-08-17T18:00:00.000Z", "2026-08-18T12:00:00.000Z"),
    ).toMatchObject({ phase: "archived" });
  });
});
