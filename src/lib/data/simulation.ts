...
const SEEDS: Seed[] = [
  ...
  { n: 3, text: "The city is loud. This is the only quiet I trust.", fires: 9, minutesAgo: 312 },
  { n: 4, text: "If you are reading this in fifty years, we hoped.", fires: 67, minutesAgo: 280 },
  { n: 5, text: "No name. No audience. One sentence. That was the point.", fires: 12, minutesAgo: 251 },
  { n: 6, text: "I paid a dollar to admit I was afraid.", fires: 23, minutesAgo: 219 },
  { n: 7, text: "We built monuments for kings. This one is for anyone.", fires: 31, minutesAgo: 188 },
  ...
  { n: 10, text: "The clock is the only editor I accept.", fires: 7, minutesAgo: 121 },
  { n: 11, text: "Left this for the version of me that survives the night.", fires: 16, minutesAgo: 96 },
  { n: 12, text: "Not a profile. Not a brand. A mark on a wall.", fires: 28, minutesAgo: 74 },
  { n: 13, text: "I hope the person after me writes something kinder.", fires: 19, minutesAgo: 58, hourFires: 8 },
  { n: 14, text: "One USDC. One day. I still think that is beautiful.", fires: 11, minutesAgo: 44, hourFires: 11 },
  { n: 15, text: "To the stranger who finds #000015: keep going.", fires: 36, minutesAgo: 33, hourFires: 22 },
  { n: 16, text: "I did not come here to be liked. I came to be recorded.", fires: 8, minutesAgo: 21, hourFires: 6 },
  { n: 17, text: "The wall does not care who I am. That is why I wrote.", fires: 14, minutesAgo: 12, hourFires: 14 },
  { n: 18, text: "If this freezes at midnight, let it freeze with this: thank you.", fires: 5, minutesAgo: 6, hourFires: 5 },
];
