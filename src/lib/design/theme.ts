import { DEFAULT_THEME, THEME_IDS, type ThemeId, themes } from "@/lib/design/tokens";

export const THEME_STORAGE_KEY = "thewall:theme";

export const THEME_BOOT_SCRIPT = `(function(){try{var a=${JSON.stringify(THEME_IDS)};var t=localStorage.getItem(${JSON.stringify(THEME_STORAGE_KEY)});if(t&&a.indexOf(t)!==-1)document.documentElement.setAttribute("data-theme",t);}catch(e){}})();`;
