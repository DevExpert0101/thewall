      ...
      <section className="admin-panel">
        ...
        <p className="admin-copy">
          {overview.config.phase === "finalizing"
            ? "Publishing has stopped. Remove illegal or immoral sentences — those drop out of Victor selection — then press Finish this Wall to disclose the final results."
