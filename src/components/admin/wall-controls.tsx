  ...
  return (
    <section className="admin-panel">
      ...
      <p className="mt-2 text-sm text-mist">
        {expired
          ? "The clock has closed. Review the rankings, remove illegal or immoral sentences, then finish this Wall to disclose the final results."
          : simulation
      ...
      >
        ...
        {askingDisclose && expired ? (
          <div className="inscribe mt-4 p-4" role="group" aria-label="Disclose final results">
            <p className="text-sm text-mist">
